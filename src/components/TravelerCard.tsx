  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden flex flex-col group transition-all duration-300 shadow-sm">
      ...
      <div className="pt-10 px-6 pb-6 flex flex-col flex-grow">
        ...
        <div className="mb-4">
          <span className="inline-block px-3 py-1 bg-[#c9eadb] text-[#4d6b5f] rounded-full text-xs font-bold mb-2">{isNearBy ? traveler.distanceKm + " km away" : ""}</span>
          <p className="text-xs text-[#3f4944] font-medium">{/* {traveler.dates} • {traveler.budget} */}</p>
        </div>
        {/* <div className="mb-2">
