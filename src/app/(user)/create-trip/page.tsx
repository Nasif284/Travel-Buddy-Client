...
import { useSetTravelStyle } from "@/src/features/user/onboarding/hooks/onboarding.hooks"; 
...
export default function Page() {
  ...
  return (
    <main className="ml-64 flex-grow flex flex-col items-center justify-start  px-4 md:py-16">
      <div className="max-w-[640px] mt-16 w-full bg-white p-8 md:p-14 rounded-2xl border border-[#bec9c3]/10 shadow-sm">
